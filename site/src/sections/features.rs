...
use crate::components::buttons::GitHubButton;
...
pub fn Features() -> impl IntoView {
    ...
    view! {
        <div class="mt-[80px]">
      <div class="bg-primary lg:h-[573px] h-[400px] w-screen absolute -z-10" />
      ...
      <div class="pt-[80px] flex flex-col items-center justify-center container mx-auto max-lg:px-6">
        ...
        <img src="/assets/chunk_load_sm.gif" class="mt-[49px] mb-[80px] rounded-xl" />
      </div>
      ...
      <div class="max-lg:py-[20px] py-[80px] flex gap-[80px] max-xl:items-center max-xl:justify-center lg:container lg:mx-auto max-lg:px-6">
        <img src="/assets/chunk_load_sm.gif" class="w-full max-w-[674px] rounded-xl max-xl:hidden" />
        ...
        <div class="flex flex-col items-start justify-center">
          ...
          <button type="button" class="mt-4 bg-primary text-white px-5 max-lg:py-4 py-2 max-lg:w-full rounded-xl">
            Download
          </button>
        </div>
      </div>
