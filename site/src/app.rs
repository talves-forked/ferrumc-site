...
use crate::{
    pages::{
        documentation::Documentation, features::FeaturesPage, home::Home, releases::Releases,
        ...
        <Layout>
            ...
            <Router>
                <Routes>
                    ...
                    <Route path="/documentation" view=move || view! { <Documentation/> }/>
                    <Route path="/releases" view=move || view! { <Releases/> }/>
                    <Route path="/styleguide" view=move || view! { <StyleGuide/> }/>
                </Routes>
            </Router>
        </Layout>
    }
        ...
        <MenuHeader variant={MenuHeaderVariant::Default.get()}>
            <MenuBar variant={MenuBarVariant::Default.get()}>
                    <div class="flex items-center justify-between">
                        <a href="/">
                        <span class="flex-none font-weight-20 text-3xl text-btn dark:text-white">FerrumC</span>
                        </a>
                        <div class="sm:hidden">
                    ...
                    <div class={move || match active(){ true => "transition-all duration-300 sm:block", false => "hidden transition-all duration-300 sm:block"}}>
                        <div class="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:pl-5">
                            ...
                            <LinkButton href="/documentation" variant={ButtonVariant::Ghost.get()}>
                                Documentation
                            </LinkButton>
                            <LinkButton href="/releases" variant={ButtonVariant::Ghost.get()}>
                                Releases
                            </LinkButton>
                        </div>
                    </div>
